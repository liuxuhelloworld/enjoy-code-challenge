...
public class Problem5_LongestPalindromicSubstring {
    ...
    public String longestPalindromeSubstringV2(String s) {
        if (s == null) {
            return null;
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(obj.longestPalindromeSubstringV2("babad"));
        System.out.println(obj.longestPalindromeSubstringV2("cbbd"));
    }
}
