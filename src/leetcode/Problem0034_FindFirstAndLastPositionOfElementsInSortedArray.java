 ...
 */
public class Problem0034_FindFirstAndLastPositionOfElementsInSortedArray {
  ...
  public static void main(String[] args) {
    Problem0034_FindFirstAndLastPositionOfElementsInSortedArray obj =
        new Problem0034_FindFirstAndLastPositionOfElementsInSortedArray();
