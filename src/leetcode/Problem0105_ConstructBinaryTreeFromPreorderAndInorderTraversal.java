 ...
 */
public class Problem0105_ConstructBinaryTreeFromPreorderAndInorderTraversal {
	...
	public static void main(String[] args) {
		Problem0105_ConstructBinaryTreeFromPreorderAndInorderTraversal obj =
			new Problem0105_ConstructBinaryTreeFromPreorderAndInorderTraversal();
